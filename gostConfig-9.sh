...
###########################################################################
wget https://github.com/dannywei7/vgost/raw/master/gost-fullua-small-9-linux.zip --no-check-certificate
unzip gost-fullua-small-9-linux.zip
mv gost-fullua-small-9-linux gost-9
chmod +x gost-9
...
nohup ./gost-9 -L wss://$your_userid:$your_pass@0.0.0.0:20?compression=true >/dev/null 2>./log/gost20.log& 

nohup ./gost-9 -L wss://$your_userid:$your_pass@0.0.0.0:1433?compression=true >/dev/null 2>./log/gost1433.log&

nohup ./gost-9 -L wss://$your_userid:$your_pass@0.0.0.0:3306?compression=true >/dev/null 2>./log/gost3306.log&
...
wget https://github.com/dannywei7/vgost/raw/master/gostClient-9.zip
...
cd /usr/local/bin/gostClient-9
zip -q -r gost-cli-9.zip /usr/local/bin/gostClient-9/
mkdir -p /var/www/html/client
mv -f /usr/local/bin/gostClient-9/gost-cli-9.zip /var/www/html/client/
	...
	yellow "http://${your_domain}/client/gost-cli-9.zip"	
